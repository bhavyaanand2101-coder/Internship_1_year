...
export default function MenProductDetails({ params }: { params: Promise<{ slug: string }> }) {
                  ...
                  {[1, 2, 3, 4, 5].map((star) => (
                    ...
                    >
                      <path
                        ...
                        strokeWidth={2}
                        d={`M12 9l2 2 4-2-6 4-2-6 4 2-2-2z${star <= product.rating ? '' : 'M12 15l-3-3 0 0 3 3Z'}`}
                      />
                    </svg>
                  ))}
                      ...
                      {[1, 2, 3, 4, 5].map((star) => (
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d={`M12 9l2 2 4-2-6 4-2-6 4 2-2-2z${star <= 5 ? '' : 'M12 15l-3-3 0 0 3 3Z'}`}
                          />
                        </svg>
                      ))}
                    </div>
                      ...
                      {[1, 2, 3, 4, 5].map((star) => (
                        ...
                        >
                          <path
                            ...
                            strokeLinejoin="round"
                            strokeWidth={2}
                            d={`M12 9l2 2 4-2-6 4-2-6 4 2-2-2z${star <= 4 ? '' : 'M12 15l-3-3 0 0 3 3Z'}`}
                          />
                        </svg>
                      ))}
                    </div>
