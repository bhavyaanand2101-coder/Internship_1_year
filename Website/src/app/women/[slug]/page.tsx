      ...
      <div className="min-h-[calc(100vh-4rem)] py-12 bg-white dark:bg-zinc-950 text-black dark:text-white transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center py-20 max-w-xl mx-auto space-y-6">
            ...
            <p className="text-xs text-gray-500 dark:text-zinc-400 leading-relaxed uppercase tracking-widest">We couldn&apos;t find that specific item. Browse our latest womenswear collection instead!</p>
            <Link href="/women" className="inline-block px-8 py-3.5 bg-black dark:bg-white text-white dark:text-black text-[10px] tracking-widest uppercase font-semibold hover:bg-zinc-800 dark:hover:bg-zinc-100 transition-colors rounded-none">
              Explore Womenswear
            </Link>
          </div>
        </div>
                ...
                <div className="divide-y divide-gray-150 dark:divide-zinc-900 border-t border-gray-150 dark:border-zinc-900">
                  ...
                  <div className="py-6 space-y-2">
                    <div className="flex items-start justify-between">
                      <div>
                        <h4 className="font-semibold text-black dark:text-white uppercase tracking-wider">Sophie Laurent</h4>
                        <p className="text-[10px] text-gray-400 dark:text-zinc-500 uppercase tracking-widest mt-0.5">Verified Buyer &bull; November 5, 2023</p>
                      </div>
                  ...
                  <div className="py-6 space-y-2">
                    <div className="flex items-start justify-between">
                      <div>
                        <h4 className="font-semibold text-black dark:text-white uppercase tracking-wider">Emily Zhang</h4>
                        <p className="text-[10px] text-gray-400 dark:text-zinc-500 uppercase tracking-widest mt-0.5">Verified Buyer &bull; October 20, 2023</p>
                      </div>
                      <div className="flex space-x-0.5">
                        {[1, 2, 3, 4, 5].map((star) => (
                          <svg
